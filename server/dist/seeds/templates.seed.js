...
exports.initialTemplates = void 0;
...
async function seedTemplates() {
    ...
    for (const tpl of exports.initialTemplates) {
        await Template_model_1.Template.findOneAndUpdate({ title: tpl.title, isDiscoverable: true }, tpl, { upsert: true, new: true });
    }
