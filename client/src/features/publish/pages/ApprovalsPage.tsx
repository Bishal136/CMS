...
export const ApprovalsPage: React.FC = () => {
  ...
  const { data: approvalPosts = [] } = useGetPostsQuery({
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] pb-12">
      ...
      <div className="border-b border-neutral-200 mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link
            ...
            className="border-b-2 border-neutral-900 text-neutral-900 font-bold pb-2.5 px-0.5 flex items-center gap-1 text-xs sm:text-sm"
          >
            <span>Approvals</span>
      ...
      {/* 3. Main Approvals Content */}
      <ApprovalsList
        approvals={approvalPosts.map((p) => ({
          id: p._id || p.id || '',
          postId: p._id || p.id || '',
          post: p,
