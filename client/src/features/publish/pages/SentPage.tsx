...
export const SentPage: React.FC = () => {
  ...
  const [composerContent, setComposerContent] = useState<string | undefined>();
  ...
  const handleRebuffer = (post: IPost) => {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] pb-12">
      ...
      {/* 3. Main Sent Content (List or Calendar) */}
      {view === 'list' ? (
        <SentList
          posts={sentPosts}
